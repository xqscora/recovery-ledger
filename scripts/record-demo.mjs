...
await page.screenshot({ path: "artifacts/recovery-ledger-planned.png", fullPage: true });
await page.waitForTimeout(35000);
await page.getByRole("button", { name: "Mark current task missed" }).click();
await page.screenshot({ path: "artifacts/recovery-ledger-recoverable.png", fullPage: true });
await page.waitForTimeout(35000);
await page.locator("#availableTime").fill("15");
await page.screenshot({ path: "artifacts/recovery-ledger-constrained.png", fullPage: true });
await page.waitForTimeout(35000);
